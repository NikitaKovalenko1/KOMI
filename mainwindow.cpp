    ...
    :QMainWindow(parent),ui(new Ui::MainWindow)
{
    ...
    //texts
    answer = new QLabel;
    grid->addWidget(answer,7,1,1,2);
    G->button(0)->setIcon(QIcon("C:/KOMIVOYA/VISUALPIC/1"));
    G->button(0)->setIconSize(maximumSize());
    G->button(1)->setIcon(QIcon("C:/KOMIVOYA/VISUALPIC/2"));
    G->button(1)->setIconSize(maximumSize());
    G->button(2)->setIcon(QIcon("C:/KOMIVOYA/VISUALPIC/3"));
    G->button(2)->setIconSize(maximumSize());
    G->button(3)->setIcon(QIcon("C:/KOMIVOYA/VISUALPIC/4"));
    G->button(3)->setIconSize(maximumSize());
    G->button(4)->setIcon(QIcon("C:/KOMIVOYA/VISUALPIC/5"));
    G->button(4)->setIconSize(maximumSize());
    btn_calc->setIcon(QIcon("C:/KOMIVOYA/VISUALPIC/6"));
    btn_calc->setIconSize(maximumSize());
    //sizes
    G->button(1)->setFixedSize(80,50);
    G->button(2)->setFixedSize(80,50);
    btn_calc->setFixedSize(100,50);
    ent1->setFixedSize(100,50);
    ent1->setStyleSheet("background-color: rgb(214,200,255)");
    ent2->setFixedSize(100,50);
    ent2->setStyleSheet("background-color: rgb(214,200,255)");
    //locations
    ...
    grid->addWidget(btn_calc,5,1,1,2);
...
void MainWindow::Fswitch()
{
    ...
    for (int i=0;i<5;i++)
    {
     ...
     G->button(buttonID)->setStyleSheet("QPushButton { background-color: rgb(154,154,154); }\n");
...
void MainWindow::F()
{
    ...
    QString result="  Схема:\n"+QString::number(result_arr_1[0])+" -> "+QString::number(result_arr_2[0]);
